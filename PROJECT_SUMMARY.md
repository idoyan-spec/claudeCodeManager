...
**גרסה / Build:** `2026-07-30 09:08 v24 portable-suite`
...
| `docs/INSTALL.md` | מדריך עברית לבעל מחשב חדש: דרישות (Collaborator לשני הריפו הפרטיים), פקודת ההתקנה האחת, מה נשאל (מפתח Gemini), איך העדכונים עובדים ואימות |
